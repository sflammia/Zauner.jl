...
@testset "shin" begin
    ...
    @test abs(shin_of_tuple(t5,[-1,0])-(0.308571164315611271 + 1.948241656082732270im)) < 10^(-10)
    @test abs(shin_of_tuple(t5,[1,1])-(0.4289984007808069358 - 0.2185856029902317735im)) < 10^(-10)
    @test abs(shin_of_tuple(t6,[-1,0])-(-1.106442644508591303 + 1.916414875949749782im)) < 10^(-10)
    @test abs(shin_of_tuple(t6,[1,1])-0.4220824403854534549) < 10^(-10)
    @test abs(shin_of_tuple(t7,[-1,0])-(-2.293459057176394784 + 0.802516033193775826im)) < 10^(-10)
    @test abs(shin_of_tuple(t7Q,[-1,0])-(-0.609275880279939336 + 2.669412047410689129im)) < 10^(-10)
    @test abs(shin_of_tuple(t8,[-1,0])-(-2.428755663366646583 - 1.006023535456928306im)) < 10^(-10)
    @test abs(shin_of_tuple(t8Q,[-1,0])-(1.040235842137503714 + 2.511351478154959377im)) < 10^(-10)
end # shin testset
